...
CHARS_DAY='0123456789'     # числа в сетке месяца
...
xl, l, t, dd = metrics("calendar_time_xl"), metrics("calendar_time_l"), metrics("calendar_temp"), metrics("calendar_day")
...
constexpr int kDayDigitH = {dd[0]}, kDayTopOffset = {dd[1]};
}}  // namespace calendar_fonts
"""
